# Guidelines to Technical Writing
...
### General guidelines
- Aim for a formal tone without uses of "I" or other informal markers. At the same time, beware of abusing passive voice: your reader should always come away knowing who/what did what.
...
2. Photos / images should be well-exposed and easy to understand. If relevant, default to diagrams if describing a setup or concept, as they are easier to read.
...
- This section is not like a lab manual that explains step by step your entire process. It should assume the reader is familiar with methods used in this field, but have enough details for the reader to be able to repeat your experiments. Most important information and details should come first, followed by other details that are important to each step of your results and discussion -- this is most likely **not** the order in which you performed the steps.
